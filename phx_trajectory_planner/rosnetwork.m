...
%  rosinit('http://192.168.0.53:11311','NodeName', 'Test') % replace own IP Adress
 setenv('ROS_MASTER_URI','http://192.168.178.26:11311');
 setenv('ROS_IP','192.168.178.54');
 rosinit('http://192.168.178.26:11311', 'NodeName', 'Test') % replace own IP Adress

 
 %copter hotspot
%  setenv('ROS_MASTER_URI','http://10.42.0.1:11311');
%  setenv('ROS_IP','10.42.0.141');
%  rosinit('http://10.42.0.1:11311', 'NodeName', 'Test') % replace own IP Adress

%local test
%  setenv('ROS_MASTER_URI','http://192.168.56.1:11311');
%  setenv('ROS_IP','10.183.94.190');
%  rosinit('http://192.168.56.1:11311', 'NodeName', 'Test') % replace own IP Adress
