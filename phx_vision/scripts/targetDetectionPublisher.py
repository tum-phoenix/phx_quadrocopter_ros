    ...
    for c in cnts:
        ...
        if len(approx) >= 3 and len(approx) <= 30:
            ...
            if keepDims and keepSolidity and keepAspectRatio and val_heigth:
                ...
                cv2.putText(frame, "d_z %.0f mm" % (dist_z), (cX+5, cY - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 255, 0), 1)
                cv2.putText(frame, "d_y %.0f mm" % (dist_x), (cX+5, cY - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 255, 0), 1)
                cv2.putText(frame, "d_x %.0f mm" % (dist_y), (cX+5, cY - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 255, 0), 1)
