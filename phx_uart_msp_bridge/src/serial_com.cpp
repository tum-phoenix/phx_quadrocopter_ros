...
bool SerialCom::init() {
    ...
    } else if  (serial_device_baud_rate == 500000) {
        input_baud_set = cfsetispeed(&usb_tio, B500000);
        output_baud_set = cfsetospeed(&usb_tio, B500000);
        std::cout << "SerialCom::init  using 500000 baudrate " << std::endl;
