...
public:
    ...
    bool prepare_msg_motor(uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0);
    bool prepare_msg_servo_big(uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0,
    ...
    bool prepare_msg_servo_small(uint16_t=0, uint16_t=0, uint16_t=0, uint16_t=0, MessageProtocol=MULTIWII_PROTOCOL);
    ...
    bool prepare_msg_pid(uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t,
...
private:
    ...
    uint16_t buffer_io_max = 100;                   // maximum numbers of bytes which are read or written during one cycle
    ...
    */
    static const uint16_t input_buffer_length = 255;
    static const uint16_t output_buffer_length = 255;
